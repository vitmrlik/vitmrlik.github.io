...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex justify-between items-center bg-background disabled:opacity-50 px-3 py-2 border border-input focus:border-ring rounded-md focus:outline-none focus:ring-2 focus:ring-ring/50 ring-offset-background focus:ring-offset-0 w-full h-10 placeholder:text-muted-foreground text-sm [&>span]:line-clamp-1 disabled:cursor-not-allowed",
      className
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex items-center focus:bg-accent data-[disabled]:opacity-50 py-2 pr-2 pl-8 rounded-sm outline-none w-full text-sm focus:text-accent-foreground cursor-default data-[disabled]:pointer-events-none select-none",
      className
    )}
    {...props}
  >
